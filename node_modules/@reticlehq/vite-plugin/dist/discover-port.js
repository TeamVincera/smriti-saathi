...
import { daemonRegistryPort, DaemonRegistryEntrySchema, pickDaemonPort, ReticleDir, } from '@reticlehq/core';
 ...
 */
export function discoverDaemonPort(projectId, home = join(homedir(), ReticleDir.ROOT), alive = isAlive) {
    const entries = [];
    let files;
    try {
