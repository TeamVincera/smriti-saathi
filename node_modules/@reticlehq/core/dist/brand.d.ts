...
export declare const asRef: (value: string) => Ref;
/** Mint a FlowName — call ONLY behind isValidFlowName, or on a literal in a test. */
export declare const asFlowName: (value: string) => FlowName;
/** Mint a SessionId — call ONLY behind isValidSessionId, or on a literal in a test. */
export declare const asSessionId: (value: string) => SessionId;
export {};
