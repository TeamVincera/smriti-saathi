 ...
 */
export declare const VerifiedReason: {
     ...
     */
    readonly OBSERVATION_LOST: "observation_lost";
 ...
 */
export declare const CDP_NO_PROVIDER_REASON = "no-cdp-provider";
export declare const CDP_NO_PROVIDER_RECOMMENDATION = "this needs a Reticle-driven browser (it is applied through CDP, which the always-on SDK cannot do) \u2014 start with `reticle drive <url>` or set RETICLE_CDP_URL";
/**
 ...
 */
export declare const BlindSpotKind: {
    readonly CLOSED_SHADOW_ROOT: "closed-shadow-root";
    /**
    ...
    readonly CROSS_ORIGIN_IFRAME: "cross-origin-iframe";
    /**
     ...
     */
    readonly UNINSTRUMENTED_FRAME: "uninstrumented-frame";
    readonly VIRTUALIZED_UNMOUNTED: "virtualized-unmounted";
    /**
     ...
     */
    readonly WRAPPED_NETWORK: "wrapped-network";
    /**
     ...
     */
    readonly UNOBSERVED_IPC: "unobserved-ipc";
    /**
     ...
     */
    readonly VERDICTLESS_SEND: "verdictless-send";
    /**
     ...
     */
    readonly UNWATCHED_STATE: "unwatched-state";
};
