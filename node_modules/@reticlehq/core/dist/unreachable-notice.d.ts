...
export declare const UNREACHABLE_NOTICE_PREFIX = "[Reticle] this page could not open a websocket to ";
/** Matches the notice and captures the address the page tried. */
export declare function unreachableUrlIn(text: string): string | undefined;
