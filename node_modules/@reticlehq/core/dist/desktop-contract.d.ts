 ...
 */
export declare const RETICLE_IPC_GLOBAL = "__reticleIpc";
/** The ipcMain channel the capture helper answers, invoked by the preload on the SDK's behalf. */
export declare const RETICLE_CAPTURE_CHANNEL = "__reticle:capture";
/**
 ...
 */
export declare const RETICLE_CAPTURE_FILE_PREFIX = "reticle-capture-";
/**
 ...
 */
export declare const RETICLE_TAURI_CAPTURE_COMMAND = "reticle_capture";
/**
 ...
 */
export declare const RETICLE_FULL_PAGE_UNSUPPORTED: string;
/**
 ...
 */
export declare const RETICLE_NOT_COMPOSITED: string;
/**
 ...
 */
export declare const DESKTOP_CONTRACT: {
    readonly RETICLE_IPC_GLOBAL: "__reticleIpc";
    readonly RETICLE_CAPTURE_CHANNEL: "__reticle:capture";
    readonly RETICLE_CAPTURE_FILE_PREFIX: "reticle-capture-";
    readonly RETICLE_TAURI_CAPTURE_COMMAND: "reticle_capture";
    readonly RETICLE_FULL_PAGE_UNSUPPORTED: string;
    readonly RETICLE_NOT_COMPOSITED: string;
};
