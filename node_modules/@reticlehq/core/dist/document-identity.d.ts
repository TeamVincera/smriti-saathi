 ...
 */
export declare const DOCUMENT_ID_LENGTH = 8;
/**
 ...
 */
export declare function newDocumentId(random: () => number): string;
/**
 ...
 */
export declare function isSameDocument(evidenceDocumentId: string | undefined, currentDocumentId: string | undefined): boolean;
