 ...
 */
export declare const PresenterTone: {
    readonly CALM: "calm";
...
export declare function isPresenterTone(value: unknown): value is PresenterTone;
/**
 ...
 */
export declare const BUFFER_EVICTION_WARNING = "event buffer evicted older events (age/size cap): a negative result here may be a false negative; the evidence may have expired. Grade sooner or widen the buffer.";
/**
 ...
 */
export declare const NO_SESSION_CONNECTED_ERROR = "no browser session connected. Two things to check: (1) your app is running with @reticlehq/browser enabled, and (2) it points at THIS daemon's port \u2014 a mismatch between the app's reticle({ port }) / VITE_RETICLE_WS_URL and the daemon's RETICLE_PORT is the usual cause. reticle_wait_ready blocks briefly for a session to appear.";
/** Surfaced on act/assert results when the target tab is throttled. */
export declare const THROTTLED_WARNING = "tab throttled; timer/rAF/pointer gestures may silently no-op; refocus before driving";
/**
 ...
 */
export declare const AGENT_STOPPED_NOTICE = "Agent stopped \u2014 switch to your terminal to continue.";
/**
 ...
 */
export declare const UNDELIVERED_NOTES_LABEL = "Undelivered (paste into your terminal):";
/** Panel notice when the agent yields after finishing its turn (reticle_yield mode:'waiting'). */
export declare const AGENT_WAITING_NOTICE = "Agent finished its turn \u2014 your move. Continue in your terminal.";
/** Panel notice prefix when the agent is blocked on you (reticle_yield mode:'ask'); the question follows. */
export declare const AGENT_ASK_NOTICE = "Agent needs your input \u2014 answer in your terminal";
/**
 ...
 */
export declare const YIELD_WITHOUT_SESSION_NOTE: string;
/**
 ...
 */
export declare const UNSCRIPTABLE_TAB_RECOMMENDATION = "tab hidden/throttled and may be un-focusable from here; refocus it, or acquire a guaranteed scriptable context yourself with `reticle_run { tool: \"reticle_lease\", action: \"acquire\", url }` (a human can equivalently run `reticle drive <url>`)";
