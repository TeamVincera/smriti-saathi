 ...
 */
export declare const ContradictionKind: {
    /** The screen moved forward while a request in the same window failed — the swallowed rejection. */
    readonly UI_ADVANCED_REQUEST_FAILED: "ui-advanced-request-failed";
    ...
    readonly SIGNAL_CONTRADICTED: "signal-contradicted";
    /** A write succeeded on the server and nothing on the client moved — the response went nowhere. */
    readonly RESPONSE_IGNORED: "response-ignored";
    /**
     ...
     */
    readonly SIGNAL_WITHOUT_CONSEQUENCE: "signal-without-consequence";
    /**
     ...
     */
    readonly CONSEQUENCE_ELSEWHERE: "consequence-elsewhere";
    /** The same write fired more than once in one action — double-submit / retry storm. */
    readonly DUPLICATE_REQUEST: "duplicate-request";
    /**
     ...
     */
    readonly STALE_RESPONSE_APPLIED: "stale-response-applied";
    /**
     ...
     */
    readonly PARTIAL_FAILURE_IN_OK_RESPONSE: "partial-failure-in-ok-response";
    /**
     ...
     */
    readonly UNIT_MISMATCH: "unit-mismatch";
    /**
     ...
     */
    readonly WRITE_FIELD_IGNORED: "write-field-ignored";
    /** The UI advanced while a request was still in flight, so `settled` was reported over a live call. */
    readonly REQUEST_NEVER_SETTLED: "request-never-settled";
    /**
     ...
     */
    readonly FAILURE_MISATTRIBUTED: "failure-misattributed";
    /**
     ...
     */
    readonly ACTION_HAD_NO_EFFECT: "action-had-no-effect";
    /**
     ...
     */
    readonly ROUTE_RENDERED_NOTHING: "route-rendered-nothing";
    /**
     ...
     */
    readonly EVIDENCE_SUPERSEDED: "evidence-superseded";
    /**
     ...
     */
    readonly EVIDENCE_PREDATES_EDIT: "evidence-predates-edit";
};
 ...
 */
export declare const ABSENCE_DERIVED_CONTRADICTIONS: ReadonlySet<ContradictionKind>;
/** True when this kind was inferred from absence rather than positively observed. */
export declare function isAbsenceDerived(kind: string): boolean;
/**
 ...
 */
export declare const FindingTier: {
    /**
     ...
     */
    readonly ABSENCE_DERIVED: "absence-derived";
};
 ...
 */
export declare function tierOfFinding(kind: string): FindingTier;
/**
 ...
 */
export declare const MUTATING_METHODS: readonly string[];
export declare const CrawlAnomalyKind: {
    readonly CONSOLE_ERROR: "console-error";
    readonly FAILED_REQUEST: "failed-request";
    readonly DEAD_CONTROL: "dead-control";
};
