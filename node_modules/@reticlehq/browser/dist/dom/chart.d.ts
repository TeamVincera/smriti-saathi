 ...
 * full parser.
 */
export declare function geometryNumbers(value: string): number[];
/** True when the attribute contains a coordinate the browser cannot render. */
export declare function hasNonFiniteCoordinate(value: string): boolean;
/** True when the geometry encloses no area — no coordinates, or every coordinate pair identical. */
export declare function isDegenerate(value: string): boolean;
/**
 ...
 */
export declare function inspectChart(root: Element): ChartReport;
 ...
 */
export declare function canvasChartData(canvas: Element, globals: {
    Chart?: {
        getChart?: (el: Element) => {
            data?: unknown;
        } | undefined;
