 ...
 */
export declare const RETICLE_OVERLAY: string;
/** Let the host app add selectors to exclude from snapshots (e.g. its own dev widgets). */
export declare function setIgnoreSelectors(selectors: string[]): void;
/** True if the element is part of Reticle's own presenter overlay. */
export declare function isReticleOverlay(el: Element): boolean;
/**
 ...
 */
export declare function isReticleUi(node: Element | null): boolean;
/** True if the element should be excluded from snapshots/queries (Reticle overlay or dev overlay). */
export declare function isIgnored(el: Element): boolean;
