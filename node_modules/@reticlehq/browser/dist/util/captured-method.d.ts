 ...
 */
export declare function capturedMethod<T>(target: object, key: PropertyKey): T | undefined;
/**
 ...
 */
export declare function requireCapturedMethod<T>(target: object, key: PropertyKey): T;
