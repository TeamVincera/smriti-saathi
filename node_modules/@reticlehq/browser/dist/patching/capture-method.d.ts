 ...
 */
export declare function captureMethod<T, K extends keyof T>(target: T, key: K): T[K];
/**
 ...
 */
export declare function captureValueSetter(proto: object): ((this: HTMLElement, value: string) => void) | undefined;
